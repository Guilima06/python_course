...
file_path = '/home/guilherme/Dropbox/HTML/Lojas/spani.html'
...
stores = soup.find_all('div', {'class': 'lojasCard'})
print(len(stores))
...
for store in stores:
    ...
    name_element = store.find('div', {'class':'col-lg-8 col-md-12 mb-2 mb-md-0'})
...
df.to_excel('/home/guilherme/Dropbox/HTML/Lojas/Storespani.xlsx', index=False)
